...
_SUBJECT_TOKENS = [
    ...
    # «Сравнение игроков»/«Сравнение спортсменов» (LeonBet) — рынок про
    # ДВУХ ИГРОКОВ, а не про две команды, хотя предмет счёта тот же.
    # Собственного токена у него не было, и «Фолы игрока (сравнение
    # игроков)» получал ключ winner1x2:fouls — тот же, что «кто из КОМАНД
    # сделает больше фолов» у Fonbet и Betcity. Цены там расходятся втрое
    # (ничья 3.34 против 12.0 на живой линии), и движок исправно объявлял
    # это вилкой в 15–22 %: ставка по ней проигрывает обеими ногами.
    ("сравнени", "players"),
...
_TOKEN_RU = {
    ...
    "aftermin": "с N-й минуты", "players": "сравнение игроков",
}
_PERIOD_RU = {
